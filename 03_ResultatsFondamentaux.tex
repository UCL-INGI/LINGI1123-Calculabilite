...
\begin{mytheo}
  ...
  \begin{proof}
    ...
    Cette fonction vaut $\bot$ si $P_n(x) = \bot$. Il s'agit donc d'une fonction partielle calculable. S'il existe une extention totale calculable de cette fonction, alors la fonction halt serait calculable.\\
