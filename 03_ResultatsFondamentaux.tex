...
Pour le démontrer, on utilisera la réduction (concept clairement défini à la section \ref{sub:r_duction}) à halt. Voici quelques exemples avant d'attaquer le cas général :
...
Un bon aperçu des question de non décidabilité pour les équations polynomiales est \cite{koenigsmann2014undecidability}.
