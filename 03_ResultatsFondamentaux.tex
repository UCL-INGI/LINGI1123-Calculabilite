...
\begin{myrem}[Démonstration du théorème de Rice grâce au point fixe]
  ...
  \begin{proof}
    ...
    \begin{itemize}
      \item Si $k \in A$, alors $f(k)=m$.  On a donc $\phi_m = \phi_k$, ce qui est contradictoire avec (1) car 
       $m \in \bar{A}$.
      \item Si $k \in \bar{A}$, alors $f(k)=n$.  On a donc $\phi_n = \phi_k$, ce qui est contradictoire avec (1) car 
        $n \in A$.
    \end{itemize}
  \end{proof}
\end{myrem}
