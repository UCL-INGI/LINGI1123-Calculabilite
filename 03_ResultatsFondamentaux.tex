...
On peut également se demander si prendre un modèle particulier est restrictif? Un modèle peut être la logique mathématique (Gödel), la machine de Turing, les langages de programmation, etc.
...
\begin{mydef}[Nombre de Gödel]
	La numération de Gödel est une fonction qui assigne à chaque symbole ou programme syntaxiquement correct d'un language, un nombre unique appelé \textbf{Nombre de Gödel} (Souvent utilisé dans les démonstrations par réduction).
\end{mydef}
