...
\begin{myexem}\label{exemple:def_func_texte}
  Définition de la table d'une fonction par un texte : "Cette fonction prend en argument un nombre entier naturel non-nul et retourne true si le nombre entré est pair, false sinon."
\end{myexem}
