...
\begin{myprop}
	...
	\begin{proof}
		On se donne un ensemble d'ensembles $X$. On suppose que cet ensemble est énumérable, c'est-à-dire que l'on peut énumérer les éléments de $X:X_0,X_1,\ldots$ De plus chaque ensemble $X_i$ est énumérable, soit $f_i$ la bijection associée. 
		...
		Comme cet ensemble contient $X_0$ qui est infini énumérable, on en déduit que $\cup X$ est énumérable.
	\end{proof}
\end{myprop}
