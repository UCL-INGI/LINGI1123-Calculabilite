...
\end{mydef}
$$\begin{array}{lll}
	0 & \Leftrightarrow & \lambda f \lambda cc \\
	1 & \Leftrightarrow & \lambda f \lambda c (fc)\\
	2 & \Leftrightarrow & \lambda f \lambda c (f(fc))\\
	... & &
\end{array}$$
Ainsi, en utilistant la règle de réduction, si N est la représentation d'un entier.\\
\begin{center}
	\begin{tabular}{ll}
...
\end{myprop}
$$\begin{array}{ll}
	[M + N] &\Leftrightarrow \lambda a \lambda b ((Ma) ((Na) b)) \\
	+ & \Leftrightarrow \lambda M \lambda N \lambda a \lambda b ((Ma) ((Na) n))
\end{array}$$
