...
Un autre exemple d'automates finis est un distributeur de boissons qui reçoit une pièce d'argent et un choix de boissons puis sert la boisson choisie. Par exemple, nous pouvons considères que la machine recois une pièce de 2 euros et a uniquement trois choix Fanta, Coca, Eau. Un tel système peut être modélisé comme suit:\\
